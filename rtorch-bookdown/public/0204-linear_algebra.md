...
#> tensor([[[0.9406, 0.6663, 0.5133,  ..., 0.4150, 0.6334, 0.2895],
#>          [0.0066, 0.4675, 0.5220,  ..., 0.9886, 0.3406, 0.0257],
#>          [0.4719, 0.5561, 0.5313,  ..., 0.1938, 0.7813, 0.8822],
#>          ...,
#>          [0.5611, 0.2408, 0.0092,  ..., 0.9986, 0.7231, 0.3741],
#>          [0.2530, 0.6928, 0.3026,  ..., 0.8944, 0.4192, 0.8850],
#>          [0.4972, 0.2432, 0.5765,  ..., 0.7691, 0.5337, 0.6260]],
#> 
#>         [[0.9321, 0.5459, 0.5974,  ..., 0.2983, 0.7084, 0.1273],
#>          [0.4761, 0.9534, 0.7419,  ..., 0.5790, 0.7361, 0.0911],
#>          [0.2789, 0.9756, 0.0351,  ..., 0.5127, 0.4415, 0.1315],
#>          ...,
#>          [0.3657, 0.0281, 0.5339,  ..., 0.7133, 0.6791, 0.0393],
#>          [0.6837, 0.7037, 0.7135,  ..., 0.2820, 0.5130, 0.6812],
#>          [0.2354, 0.5400, 0.6830,  ..., 0.1359, 0.4379, 0.3382]],
#> 
#>         [[0.3035, 0.0678, 0.7924,  ..., 0.2452, 0.8107, 0.7492],
#>          [0.3953, 0.5481, 0.4870,  ..., 0.1743, 0.5801, 0.9975],
#>          [0.6828, 0.5977, 0.6156,  ..., 0.9641, 0.8876, 0.7981],
#>          ...,
#>          [0.7945, 0.5705, 0.6571,  ..., 0.2721, 0.7012, 0.1391],
#>          [0.7643, 0.7438, 0.5161,  ..., 0.7091, 0.8764, 0.8766],
#>          [0.1172, 0.2209, 0.2908,  ..., 0.1834, 0.2846, 0.9464]]])
img$shape
#> torch.Size([3, 28, 28])
```
...
a$mm(b)
#> tensor([[-0.7348, -0.3528, -0.2967,  0.5455],
#>         [-1.2992, -0.8217, -0.3118,  0.7636]])
a$matmul(b)
#> tensor([[-0.7348, -0.3528, -0.2967,  0.5455],
#>         [-1.2992, -0.8217, -0.3118,  0.7636]])
```
