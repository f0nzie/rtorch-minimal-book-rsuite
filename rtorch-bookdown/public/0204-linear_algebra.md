...
#> tensor([[[0.0353, 0.6500, 0.4389,  ..., 0.9952, 0.1506, 0.2661],
#>          [0.2980, 0.6033, 0.4351,  ..., 0.9010, 0.7527, 0.7626],
#>          [0.9067, 0.2759, 0.2084,  ..., 0.2947, 0.7542, 0.0841],
#>          ...,
#>          [0.4964, 0.9851, 0.8776,  ..., 0.8639, 0.8199, 0.5068],
#>          [0.3554, 0.6145, 0.7621,  ..., 0.7023, 0.9111, 0.6067],
#>          [0.3082, 0.5269, 0.2663,  ..., 0.9105, 0.3228, 0.4771]],
#> 
#>         [[0.0754, 0.7885, 0.3656,  ..., 0.1362, 0.7344, 0.9324],
#>          [0.6647, 0.8442, 0.9598,  ..., 0.0784, 0.0882, 0.1900],
#>          [0.8705, 0.1768, 0.5568,  ..., 0.1821, 0.3746, 0.1743],
#>          ...,
#>          [0.9600, 0.4703, 0.9570,  ..., 0.9289, 0.2746, 0.2816],
#>          [0.5412, 0.7906, 0.1017,  ..., 0.2394, 0.9331, 0.1017],
#>          [0.9634, 0.3389, 0.2378,  ..., 0.2157, 0.0660, 0.6508]],
#> 
#>         [[0.0709, 0.7341, 0.5649,  ..., 0.1000, 0.5545, 0.5562],
#>          [0.7399, 0.5990, 0.8879,  ..., 0.9520, 0.7993, 0.5252],
#>          [0.9586, 0.4849, 0.0904,  ..., 0.7627, 0.5820, 0.7520],
#>          ...,
#>          [0.1696, 0.3323, 0.8847,  ..., 0.6882, 0.5813, 0.5073],
#>          [0.6989, 0.2893, 0.4263,  ..., 0.6179, 0.3525, 0.9503],
#>          [0.4711, 0.9829, 0.4961,  ..., 0.1779, 0.0599, 0.6933]]])
img$shape
#> torch.Size([3, 28, 28])
```
...
a$mm(b)
#> tensor([[ 0.5212, -2.8996, -0.9501, -2.4544],
#>         [-1.0965, -0.8546, -0.0948,  1.5794]])
a$matmul(b)
#> tensor([[ 0.5212, -2.8996, -0.9501, -2.4544],
#>         [-1.0965, -0.8546, -0.0948,  1.5794]])
```
