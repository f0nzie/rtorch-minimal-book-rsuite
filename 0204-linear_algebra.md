...
#> tensor([[[0.2340, 0.3828, 0.6446,  ..., 0.7164, 0.4065, 0.2352],
#>          [0.8160, 0.5704, 0.7304,  ..., 0.5735, 0.7694, 0.2255],
#>          [0.8125, 0.2182, 0.7164,  ..., 0.2336, 0.9739, 0.1759],
#>          ...,
#>          [0.5792, 0.0054, 0.7785,  ..., 0.9056, 0.2010, 0.5388],
#>          [0.4288, 0.6506, 0.2438,  ..., 0.9242, 0.0811, 0.6308],
#>          [0.5169, 0.6707, 0.7254,  ..., 0.0285, 0.8195, 0.3811]],
#> 
#>         [[0.4872, 0.8200, 0.2137,  ..., 0.8010, 0.3078, 0.3122],
#>          [0.7057, 0.5176, 0.2336,  ..., 0.1730, 0.4599, 0.7185],
#>          [0.2573, 0.3282, 0.1669,  ..., 0.6791, 0.8521, 0.1105],
#>          ...,
#>          [0.8233, 0.2683, 0.2291,  ..., 0.4702, 0.2980, 0.1801],
#>          [0.6441, 0.3026, 0.2811,  ..., 0.1800, 0.9933, 0.6809],
#>          [0.0180, 0.4391, 0.5946,  ..., 0.8308, 0.3496, 0.0098]],
#> 
#>         [[0.7794, 0.9102, 0.5455,  ..., 0.1684, 0.2108, 0.2129],
#>          [0.0480, 0.7227, 0.7689,  ..., 0.5458, 0.1328, 0.4799],
#>          [0.5743, 0.9217, 0.6627,  ..., 0.5269, 0.4471, 0.0361],
#>          ...,
#>          [0.3580, 0.9370, 0.0537,  ..., 0.9707, 0.8620, 0.6104],
#>          [0.1380, 0.1459, 0.5186,  ..., 0.6406, 0.8320, 0.1941],
#>          [0.3965, 0.2196, 0.4389,  ..., 0.3337, 0.9860, 0.9671]]])
img$shape
#> torch.Size([3, 28, 28])
```
...
a$mm(b)
#> tensor([[ 0.3318,  1.8743,  1.0379, -0.5480],
#>         [-1.4726,  2.9532, -1.1073, -3.1027]])
a$matmul(b)
#> tensor([[ 0.3318,  1.8743,  1.0379, -0.5480],
#>         [-1.4726,  2.9532, -1.1073, -3.1027]])
```
